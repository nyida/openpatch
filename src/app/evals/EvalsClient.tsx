    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        {versions.length === 0 ? (
          ...
          <div className="overflow-x-auto rounded-xl border border-slate-200 scroll-smooth">
      ...
      {recentResults.length > 0 && (
        <div className="card">
          ...
          <div className="overflow-auto max-h-60 rounded-xl border border-slate-200 scroll-smooth">
            <table className="w-full text-sm">
